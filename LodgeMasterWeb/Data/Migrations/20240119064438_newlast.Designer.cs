...
namespace LodgeMasterWeb.Data.Migrations
{
    ...
    [Migration("20240119064438_newlast")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LodgeMasterWeb.Core.Models.CompanyLinkBranche", b =>
                {
                    b.Property<string>("LinkCBID")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");
            ...
            modelBuilder.Entity("LodgeMasterWeb.Core.Models.OrderMaster", b =>
                {
                    ...
                    b.HasIndex("DepartmentAssignUserId");
            ...
            modelBuilder.Entity("LodgeMasterWeb.Core.Models.OrderMaster", b =>
                {
                    b.HasOne("LodgeMasterWeb.Core.Models.ApplicationUser", "DepartmentAssignUser")
                        .WithMany()
                        .HasForeignKey("DepartmentAssignUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("LodgeMasterWeb.Core.Models.ApplicationUser", "UserAssigned")
                        .WithMany()
                        .HasForeignKey("UserIDAssign")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LodgeMasterWeb.Core.Models.ApplicationUser", "UserCreated")
                        .WithMany()
                    ...
                    b.Navigation("DepartmentAssignUser");
