...
namespace LodgeMasterWeb.Data.Migrations
{
    ...
    [Migration("20240912063332_Departmentisdefault")]
    partial class Departmentisdefault
    {
            ...
            modelBuilder.Entity("LodgeMasterWeb.Core.Models.WhatsappBotAction", b =>
                {
                    ...
                    b.Property<string>("FlowChartDetailFCDetailsID")
                        .HasColumnType("nvarchar(250)");
                    ...
                    b.Property<string>("OrderMasterOrderID")
                        .HasColumnType("nvarchar(250)");
                    ...
                    b.HasIndex("FlowChartDetailFCDetailsID");
            ...
            modelBuilder.Entity("LodgeMasterWeb.Core.Models.WhatsappBotAction", b =>
                {
                    ...
                    b.HasOne("LodgeMasterWeb.Core.Models.FlowChartDetail", null)
                        .WithMany()
                    ...
                    b.HasOne("LodgeMasterWeb.Core.Models.FlowChartDetail", "FlowChartDetail")
                        .WithMany()
                        .HasForeignKey("FlowChartDetailFCDetailsID");

                    b.HasOne("LodgeMasterWeb.Core.Models.OrderMaster", null)
                        .WithMany()
