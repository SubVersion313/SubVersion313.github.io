...
namespace LodgeMasterWeb.Data.Migrations
{
    ...
    [Migration("20241105134704_Timemanagement_Tasks")]
    partial class Timemanagement_Tasks
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LodgeMasterWeb.Core.Models.Department", b =>
                {
                    ...
                    b.Property<string>("MasterNameDefault")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LodgeMasterWeb.Core.Models.TmCreditRoom", b =>
                {
                    b.Property<string>("CreditRoomId")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");
                    ...
                    b.Property<int>("RoomSets")
                        .HasColumnType("int");

                    b.Property<string>("UFShiftStatus")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("CreditRoomId");

                    b.ToTable("TmCreditRooms");
                });

            modelBuilder.Entity("LodgeMasterWeb.Core.Models.TmEmpCredit", b =>
                {
                    b.Property<string>("UFShiftId")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");
                    ...
                    b.ToTable("TmEmployeesCredit");
                });

            modelBuilder.Entity("LodgeMasterWeb.Core.Models.TmShiftsWork", b =>
                {
                    ...
                    b.Property<string>("ShiftName_A")
                        .IsRequired()
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");

                    b.Property<string>("ShiftName_E")
                        .IsRequired()
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");
                    ...
                    b.ToTable("TmShiftsWorks");
                });

            modelBuilder.Entity("LodgeMasterWeb.Core.Models.TmShiftWeek", b =>
                {
                    b.Property<string>("ShiftWeekId")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");
                    ...
                    b.Property<int>("dt_End")
                        .HasColumnType("int");

                    b.Property<int>("dt_Start")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ShiftWeekId");

                    b.ToTable("TmShiftWeeks");
                });

            modelBuilder.Entity("LodgeMasterWeb.Core.Models.TmSys_Service", b =>
                {
                    b.Property<string>("SerivceID")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("SerivceName_ar")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SerivceName_en")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("TmSys_Services");
                });

            modelBuilder.Entity("LodgeMasterWeb.Core.Models.TmWeekDetails", b =>
                {
                    b.Property<string>("TmDet_ID")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");
                    ...
                    b.Property<string>("WeekMsID")
                        .IsRequired()
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");

                    b.Property<string>("YearNo")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("TmWeeksDetails");
                });

            modelBuilder.Entity("LodgeMasterWeb.Core.Models.TmWeekMaster", b =>
                {
                    b.Property<string>("WeekMsID")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");
                    ...
                    b.ToTable("TmWeeksMaster");
                });

            modelBuilder.Entity("LodgeMasterWeb.Core.Models.TmWeekTasks", b =>
                {
                    b.Property<string>("TmWeek_DetID")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<DateTime?>("dtTransOrder")
                        .HasColumnType("datetime2");

                    b.Property<int>("iSorted")
                        .HasColumnType("int");

                    b.Property<int>("isTransOrder")
                        .HasColumnType("int");
                    ...
                    b.HasKey("TmWeek_DetID");

                    b.HasIndex("TmDet_ID");

                    b.ToTable("TmWeeksTasks");
                });
            ...
            modelBuilder.Entity("LodgeMasterWeb.Core.Models.VMOrders", b =>
                {
                    ...
                    b.Property<int>("SupervisorUserAssign")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LodgeMasterWeb.Core.Models.WhatsappBotAction", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");
                    ...
                    b.HasIndex("FCDetailsID");

                    b.HasIndex("OrderId");

                    b.HasIndex("UserId");

                    b.ToTable("WhatsappBotActions");
                });
            ...
            modelBuilder.Entity("LodgeMasterWeb.Core.ViewModels.ChartLineMonthVM", b =>
                {
                    ...
                    b.ToView("VMChartLineMonth");
                });

            modelBuilder.Entity("LodgeMasterWeb.Core.ViewModels.ChartLineVM", b =>
                {
                    b.Property<int>("CountData")
                        .HasColumnType("int");
                    ...
                    b.ToView("VMChartLine");
                });

            modelBuilder.Entity("LodgeMasterWeb.Core.ViewModels.ChartLineWeekVM", b =>
                {
                    b.Property<int>("CountData")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LodgeMasterWeb.Core.ViewModels.VMOrderDetItem", b =>
                {
                    b.Property<string>("CompanyID")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LodgeMasterWeb.Core.Models.TmWeekDetails", b =>
                {
                    b.HasOne("LodgeMasterWeb.Core.Models.TmWeekMaster", "TmWeekMaster")
                        .WithMany()
                        .HasForeignKey("WeekMsID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TmWeekMaster");
                });

            modelBuilder.Entity("LodgeMasterWeb.Core.Models.TmWeekTasks", b =>
                {
                    b.HasOne("LodgeMasterWeb.Core.Models.TmWeekDetails", "TmWeekDetails")
                        .WithMany()
                        .HasForeignKey("TmDet_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TmWeekDetails");
                });

            modelBuilder.Entity("LodgeMasterWeb.Core.Models.WhatsappBotAction", b =>
                {
                    b.HasOne("LodgeMasterWeb.Core.Models.FlowChartDetail", "FlowChartDetail")
                        .WithMany("WhatsappBotActions")
                        .HasForeignKey("FCDetailsID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LodgeMasterWeb.Core.Models.OrderMaster", "OrderMaster")
                        .WithMany("WhatsappBotActions")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LodgeMasterWeb.Core.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("WhatsappBotActions")
            ...
            modelBuilder.Entity("LodgeMasterWeb.Core.Models.ApplicationUser", b =>
                {
                    b.Navigation("WhatsappBotActions");
                });
